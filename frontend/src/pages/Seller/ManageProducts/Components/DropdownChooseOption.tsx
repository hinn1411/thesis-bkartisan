...
import {IOptions} from '../../../../apis/apiOptions';
...
function DropdownChooseOption({name, optionNames, handleOptionChange }: DropdownProps) {
    ...
    const filteredOptions = optionNames ? optionNames.filter((option: IOptions) =>
...
export default DropdownChooseOption;
