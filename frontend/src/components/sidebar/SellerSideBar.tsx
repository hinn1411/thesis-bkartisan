    ...
    <aside
      ...
      <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            ...
            <li>
                <a href="#" className={`flex  items-center p-2 text-gray-500 rounded-lg  group ${name == "Discount"? `bg-orange-500 text-white` : `hover:bg-orange-100 hover:text-gray-900`} group`}>
                  <MdOutlineDiscount className={`w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 ${name == "Discount"? ` text-white` : `group-hover:text-gray-900 `} `}></MdOutlineDiscount>
