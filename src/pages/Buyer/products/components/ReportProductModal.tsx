...
import { product as productResponse } from "@contants/response";
...
const ReportProductModal: FC<ModalProps> = memo(
  ({ isOpen, setIsOpen, user, product }) => {
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left flex-1">
                        ...
                        <Dialog.Description className="relative">
                          ...
                          <div className="mt-2 text-start">
                            ...
                            {productResponse.map((item, index) => (
                              <div
                                key={index}
                                className="flex items-center mb-4"
                              >
                                <input
                                  defaultChecked={item === productResponse[0]}
                                  id={item}
                                  type="radio"
                                  value={item}
                                  name="default-radio"
