...
import { useCreateDiscount } from './Hooks/useMutationDiscount';
...
const CreateDiscount: FC<YourComponentProps> = memo(() => {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    if(data.type === "bill") {
      ...
      createDiscount.mutate(discountDataNormal);
    }
  }
  ...
  return (
    <div>
      ...
      {
        createDiscount.isSuccess && (
          <SuccessAdd message='Thêm mã thành công' url='/seller/manage_discounts' onDismiss={handleMutationSuccess}></SuccessAdd>
        )
      }
      {
