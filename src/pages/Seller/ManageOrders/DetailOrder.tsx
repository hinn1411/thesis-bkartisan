            ...
            <div>
                ...
                <div className='col-span-7/12 flex flex-col justify-between border rounded-md p-4 shadow-md'>
                  ...
                  <div className='border-t-2 space-y-4 pt-3'>
                      ...
                      <div className='flex space-x-5'>
                        ...
                        {
                          order.order.isReturn ? (<div className='h-auto w-auto px-2 bg-blue-100 hover:bg-blue-300 border rounded-lg border-blue-700 cursor-pointer'>Thông tin</div>) : null
                        }
                      </div>
                  </div>
                </div>
              ...
              <div className='max-w-3xl mx-auto mt-10'>
                <div className='flex justify-center space-x-10 sm:space-x-40 '>
                  <button type="button" className="border border-orange-500 hover:bg-orange-200  focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-10 py-2.5 text-center  dark:focus:ring-orange-800">Chat với người mua</button>
